...
const layoutend = lazy(() => import("./views/forms/form-layouts/FormLayoutsend"))
const layoutenddevices = lazy(() => import("./views/tables/aggrid/Aggrid4enddevices"))
...
const EndDeviceDetail = lazy(() => import("./views/apps/user/view/EndDeviceDetail"))
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          <AppRoute path="/enddevice/addenddevice" component={layoutend} />
          <AppRoute path="/enddevice/enddevices" component={layoutenddevices} />
          ...
          <AppRoute path="/EndDevice/EndDeviceDetail/:enddeviceID" component={EndDeviceDetail} />
