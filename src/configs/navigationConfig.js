...
const navigationConfig = [
  ...
  {
    type: "groupHeader",
    groupTitle: "END DEVICES"
  },
  {
    id: "formLayoutsend",
    title: "Add End Device",
    type: "item",
    icon: <Icon.Box size={20} />,
    permissions: ["admin", "editor"],
    navLink: "/enddevice/addenddevice"
  },
  {
    id: "formLayoutsenddevices",
    title: "End Devices",
    type: "item",
    icon: <Icon.Box size={20} />,
    permissions: ["admin", "editor"],
    navLink: "/enddevice/enddevices"
  },
  {
    id: "view",
    title: "View",
    ...
    icon: <Icon.Circle size={12} />,
    permissions: ["admin", "editor"],
    navLink: "/EndDevice/EndDeviceDetail"
  },
  {
    type: "groupHeader",
